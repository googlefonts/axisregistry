...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {},
            [
                ("14pt Thin", {"wght": 100.0}),
                ("14pt ExtraLight", {"wght": 200.0}),
                ("14pt Light", {"wght": 300.0}),
                ("14pt Regular", {"wght": 400.0}),
                ("14pt Medium", {"wght": 500.0}),
                ("14pt SemiBold", {"wght": 600.0}),
                ("14pt Bold", {"wght": 700.0}),
                ("14pt ExtraBold", {"wght": 800.0}),
                ("14pt Black", {"wght": 900.0}),
                ("14pt Thin Italic", {"wght": 100.0, "slnt": -10}),
                ("14pt ExtraLight Italic", {"wght": 200.0, "slnt": -10}),
                ("14pt Light Italic", {"wght": 300.0, "slnt": -10}),
                ("14pt Italic", {"wght": 400.0, "slnt": -10}),
                ("14pt Medium Italic", {"wght": 500.0, "slnt": -10}),
                ("14pt SemiBold Italic", {"wght": 600.0, "slnt": -10}),
                ("14pt Bold Italic", {"wght": 700.0, "slnt": -10}),
                ("14pt ExtraBold Italic", {"wght": 800.0, "slnt": -10}),
                ("14pt Black Italic", {"wght": 900.0, "slnt": -10}),
            ],
        ),
